...
Ext.define('doflamingo.view.message_condition.MessageConditionChart', {
    ...
    initComponent : function(){
        ...
        Ext.applyIf(this,{
            plain   : true,
            layout  : 'fit',
            html    : '<messageConditionChart></messageConditionChart>',
            border  : false
        });
    ...
    drawChart: function(me, width, height) {
        ...
        function setupChart(data) {
            ...
            var selector = "#" + me.getId().toString() + " messageConditionChart svg";

            d3.select(selector).remove();
            selector = "#" + me.getId().toString() + " messageConditionChart";

            d3.select(selector).append("svg")
                .attr("width", width)
                .attr("height", height - 35);

            selector = "#" + me.getId().toString() + " messageConditionChart svg";
